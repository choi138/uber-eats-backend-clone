...
import { Order } from './orders/entitites/order.entity';
import { OrderItem } from './orders/entitites/order-items.dto';
@Module({
  imports: [
    ...
    TypeOrmModule.forRoot({
      ...
      entities: [User, Verification, Restaurant, Category, Menu, Order, OrderItem]
    }),
